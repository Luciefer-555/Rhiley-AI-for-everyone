...
const LiquidMetalBackground = dynamic(() => import("@/components/liquid-metal-background").then(mod => ({ default: mod.LiquidMetalBackground })), {
  ssr: false,
  loading: () => <div className="fixed inset-0 bg-black" />
})

const FloatingNavbar = dynamic(() => import("@/components/floating-navbar").then(mod => ({ default: mod.FloatingNavbar })), {
  ssr: false
})

const ShinyButton = dynamic(() => import("@/components/ui/shiny-button").then(mod => ({ default: mod.ShinyButton })), {
  loading: () => <button className="px-8 py-3 text-base bg-white text-black rounded-lg">Loading...</button>
})

const Feature = dynamic(() => import("@/components/ui/feature-with-advantages").then(mod => ({ default: mod.Feature })), {
  ssr: false
})

const BentoPricing = dynamic(() => import("@/components/ui/bento-pricing").then(mod => ({ default: mod.BentoPricing })), {
  ssr: false
})
...
const AboutQuote = dynamic(() => import("@/components/ui/about-quote").then(mod => ({ default: mod.AboutQuote })), {
  ssr: false
})
