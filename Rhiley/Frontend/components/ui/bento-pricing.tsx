  ...
  return (
    <div className="grid grid-cols-1 gap-1.5 md:grid-cols-2 lg:grid-cols-8">
      ...
      >
        ...
        <div className="flex flex-col p-3 lg:flex-row">
          ...
          <ul className="text-gray-300 grid gap-2 text-xs lg:w-[70%] font-open-sans-custom">
            {[
              "₹499 of included monthly credits",
      ...
      <PricingCard
        ...
        priceLabel="₹0"
        features={[
          "₹1000 of included monthly credits",
      ...
      <PricingCard
        ...
        features={[
          "₹3000 of included monthly credits per user",
      ...
      <PricingCard
        ...
        priceLabel="₹10000"
        priceSuffix="/user/month"
        features={["₹10000 of included monthly credits per user", "Training opt-out by default", "Access to v0 API"]}
        className="lg:col-span-4"
      />
