...
const CONFIG = {
    ...
    models: [
        { id: "nvidia/nemotron-3-nano-omni", label: "NIM Vision", emoji: "VISION" },
        { id: "meta/llama-3.1-8b-instruct", label: "NIM Light", emoji: "CHAT" },
        { id: "nvidia/nemotron-3-super-120b-a12b", label: "NIM Coder", emoji: "CODE" },
    ],
    services: [
        {
...

        {
            ...
            emoji: "🌐",
            cwd: path.join(ROOT, "Backend", "browser-service"),
            cmd: "node",
            args: ["server.js"],
            port: 3005,
            node: true,
...
${C.reset}
  ...
  ${C.gray}Powered by NVIDIA NIM Â· Nemotron Â· Llama 3.1${C.reset}
  ${"â• ".repeat(50)}
`);
}
...
${C.green}${C.bold}
  ...
  â•‘   ðŸŒ  Browser Intel â†’  http://localhost:3005     â•‘
  â•‘   ðŸ¤–  Ollama        â†’  http://localhost:11434    â•‘
  â•‘                                                  â•‘
  â•‘   ðŸ‘ ï¸    NIM Vision     Â·  ðŸ¦™ Llama 3.1            â•‘
  â•‘   ðŸ ‹  NIM Coder                                 â•‘
  â•‘                                                  â•‘
