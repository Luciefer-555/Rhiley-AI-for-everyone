          ...
          >
            <div className="flex items-center gap-2 border-b border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
              <div className="flex items-center gap-2">
                <div className="grid h-8 w-8 place-items-center rounded-xl bg-zinc-900 dark:bg-zinc-800 shadow-sm overflow-hidden">
                  <img src="/logo.png" alt="Rhiley Logo" className="h-5 w-5 object-contain" />
                </div>
                <div className="text-sm font-semibold tracking-tight">Rhiley</div>
              </div>
                ...
                {pinned.length === 0 ? (
                  ...
                  pinned.map((c) => (
                    <ConversationRow
                      ...
                      onRename={(newName) => onRenameConversation(c.id, newName)}
                    />
                  ))
                )}
              </SidebarSection>
