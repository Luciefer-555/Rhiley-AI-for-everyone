...
export default function ComposerActionsPopover({ children, onImageUpload, onCreativeStudioOpen }) {
  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = (event) => {
      onImageUpload?.({ name: file.name, dataUrl: event.target.result, file: file })
    }
    reader.readAsDataURL(file)
    // Clear the input so the user can select the same file again later
    e.target.value = ""
  }
