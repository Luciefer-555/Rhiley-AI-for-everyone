...
const CONFIG = {
    ...
    models: [
        { id: "llava:7b", label: "LLaVA Vision", emoji: "VISION" },
        { id: "qwen3:8b", label: "Qwen 3 Chat", emoji: "CHAT" },
        { id: "qwen2.5-coder:7b", label: "Qwen Coder", emoji: "CODE" },
        { id: "x/z-image-turbo", label: "Image Turbo", emoji: "IMAGE" },
    ],
    services: [
        {
