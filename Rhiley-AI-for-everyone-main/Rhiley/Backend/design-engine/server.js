...
const scrapeRoute = require("./routes/scrape"); // 🌐 Browser Intelligence
...
app.use("/scrape", scrapeRoute);          // 🌐 Browser Intelligence endpoint
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`🌐 /scrape endpoint active — Browser Intelligence ready`);
});
