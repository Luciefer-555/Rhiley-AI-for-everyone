...
def health():
    return jsonify({"status": "ok", "service": "opencv-analyzer"})
...
if __name__ == '__main__':
    # Port 5001 is the single canonical OpenCV endpoint used by both engines.
    # Disable Flask's reloader so the Node launcher owns one child process.
